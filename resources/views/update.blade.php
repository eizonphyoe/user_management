                     ...
                     <div>
                        <form action="/create" method="post">
                            @csrf
                               ...
                               <table class="update">
                                   <thead><h3 class="label">Update the information!</h3></thead>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="user_type">
                                            <option value={{$data->user_type}}>Customer</option>
                                ...
                                ><tr> <td colspan="2"><input type="submit" class="btn_update" name="update" value="UPDATE"></td></tr>
                               </table>
